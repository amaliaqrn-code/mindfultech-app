...
import 'widgets/purple_mascot_widget.dart';
import 'widgets/purple_category_grid_widget.dart';
import 'widgets/purple_recommendation_card.dart';
import 'widgets/purple_alternative_task_list.dart';
import 'widgets/purple_confirmation_card.dart';
import 'widgets/purple_action_button.dart';
import 'theme/purple_theme.dart';

/// Layar "Mindy Bantu Aku - Energi Tinggi" dengan Purple Theme
class MindyBantuAkuPurpleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Get energy level from arguments (high = 2)
    ...
    if (args != null && args['energy'] != null) {
      ...
      // Default to high energy if not specified
      controller.initializeWithEnergy(EnergyLevel.high);
    }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Purple Mascot with lightning
                    const PurpleMascotWidget(size: 100),
  ...
  Widget _buildHeader(ChooseEnergyController controller) {
    return Padding(
      ...
      child: Row(
        children: [
          PurpleBackButton(onTap: () => controller.goBack()),
          const Spacer(),
      ...
      children: List.generate(ChooseEnergyStep.values.length, (index) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isActive ? PurpleTheme.primaryPurple : PurpleTheme.borderLight,
          ),
        );
      }),
    );
  ...
  Widget _buildActionButton(ChooseEnergyController controller) {
    ...
    switch (step) {
      ...
      case ChooseEnergyStep.recommendation:
        text = 'Aku siap fokus!';
        useGradient = false; // Solid purple for this step
        break;
