...
class _MindyBantuAkuRendahScreenState extends State<MindyBantuAkuRendahScreen> {
  ...
  static const Color primaryGreen = Color(0xFF5D8A57);
  static const Color mintGreenBg = Color(0xFFE3EFE0);
  static const Color subtitleGreen = Color(0xFF8FA88B);
  ...
  Widget _buildMascot() {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          // Floating leaves on the left
          Positioned(
            left: 10,
            top: 20,
            child: _buildFloatingLeaf(rotation: -0.4, size: 24),
          ),
          // Floating leaves on the right
          Positioned(
            right: 20,
            top: 10,
  ...
  Widget _buildCategoryCard({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Colors.white : mintGreenBg,
          ...
          children: [
            Expanded(
              child: Image.asset(
                ...
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) {
                  return _buildFallbackIcon(label);
                },
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected ? primaryGreen : primaryGreen.withValues(alpha: 0.8),
              ),
              textAlign: TextAlign.center,
            ),
          ],
