...
/// Layar "Mindy Bantu Aku" - Pemilihan Kategori ENERGI SEDANG
/// Tema: Biru dengan nuansa tenang dan fokus
class MindyBantuAkuSedangScreen extends StatefulWidget {
  const MindyBantuAkuSedangScreen({super.key});

  @override
  State<MindyBantuAkuSedangScreen> createState() => _MindyBantuAkuSedangScreenState();
}

class _MindyBantuAkuSedangScreenState extends State<MindyBantuAkuSedangScreen> {
  ...
  // Colors - Biru
  static const Color primaryColor = Color(0xFF4597E6);
  static const Color secondaryColor = Color(0xFF7BBEFF);
  static const Color cardBg = Color(0xFFE3F2FD);
  static const Color subtitleColor = Color(0xFF6B9BC3);
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            left: 10,
            top: 20,
            child: _buildFloatingSparkle(rotation: -0.4, size: 22),
          ),
          Positioned(
            right: 20,
            top: 10,
            child: _buildFloatingSparkle(rotation: 0.3, size: 18),
          ),
          Positioned(
            right: 5,
            top: 45,
            child: _buildFloatingSparkle(rotation: 0.5, size: 16),
          ),
          _buildCloudMascot(),
        ],
      ),
  ...
  Widget _buildFloatingSparkle({double rotation = 0, double size = 20}) {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [primaryColor.withValues(alpha: 0.7), secondaryColor.withValues(alpha: 0.7)],
