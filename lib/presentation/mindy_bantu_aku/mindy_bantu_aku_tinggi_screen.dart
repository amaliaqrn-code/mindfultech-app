...
/// Tema: Ungu dengan nuansa energik dan semangat
class MindyBantuAkuTinggiScreen extends StatefulWidget {
  const MindyBantuAkuTinggiScreen({super.key});

  @override
  State<MindyBantuAkuTinggiScreen> createState() => _MindyBantuAkuTinggiScreenState();
}

class _MindyBantuAkuTinggiScreenState extends State<MindyBantuAkuTinggiScreen> {
  ...
  // Colors - Ungu
  static const Color primaryColor = Color(0xFF8E6DC9);
  static const Color secondaryColor = Color(0xFFB388FF);
  static const Color cardBg = Color(0xFFEDE7F6);
  static const Color subtitleColor = Color(0xFF9575CD);
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            left: 5,
            top: 15,
            child: _buildFloatingStar(rotation: -0.3, size: 22),
          ),
          Positioned(
            right: 15,
            top: 5,
            child: _buildFloatingStar(rotation: 0.2, size: 20),
          ),
          Positioned(
            right: 0,
            top: 50,
            child: _buildFloatingStar(rotation: 0.4, size: 16),
          ),
          _buildCloudMascot(),
        ],
      ),
  ...
  Widget _buildFloatingStar({double rotation = 0, double size = 20}) {
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? [BoxShadow(color: primaryColor.withValues(alpha: 0.25), blurRadius: 8, offset: const Offset(0, 2))]
