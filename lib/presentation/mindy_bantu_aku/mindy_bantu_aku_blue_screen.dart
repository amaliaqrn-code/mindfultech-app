...
/// Tema: Biru dengan nuansa energik
///
/// Alur:
...
class _MindyBantuAkuBlueScreenState extends State<MindyBantuAkuBlueScreen> {
  ...
  // Task recommendations based on category (Medium Energy)
  final Map<String, List<Map<String, dynamic>>> _tasksByCategory = {
    ...
    'Pekerjaan': [
      ...
      {'title': 'Review project plan', 'duration': '1 jam', 'category': 'Kerja', 'color': const Color(0xFF7BBEFF)},
    ],
    'Kesehatan': [
    ...
    'Lainnya': [
      ...
      {'title': 'Kerja project pribadi', 'duration': '2 jam', 'category': 'Lainnya', 'color': const Color(0xFF607D8B)},
    ],
  };

  // Colors - Biru Energy
  static const Color primaryColor = Color(0xFF4597E6);
  static const Color cardBg = Color(0xFFE8F4FD);
  static const Color subtitleColor = Color(0xFF7BBEFF);
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: 25,
            top: 35,
            child: Icon(Icons.star_rounded, color: primaryColor.withValues(alpha: 0.25), size: 24),
          ),
          Positioned(
            right: 35,
            top: 25,
            child: Icon(Icons.star_rounded, color: primaryColor.withValues(alpha: 0.2), size: 18),
          ),
          Positioned(
            right: 15,
            top: 65,
            child: Icon(Icons.star_rounded, color: primaryColor.withValues(alpha: 0.15), size: 14),
          ),
          // Main mascot
          _buildCloudMascot(),
        ],
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [primaryColor, subtitleColor],
                ),
              ),
