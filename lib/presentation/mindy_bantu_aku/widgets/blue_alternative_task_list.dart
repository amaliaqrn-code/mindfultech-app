    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? BlueTheme.primaryBlueDark : BlueTheme.primaryBluePale,
  ...
  Widget _buildRadioIndicator() {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: isSelected ? BlueTheme.primaryNavy : BlueTheme.backgroundWhite,
      ),
    );
  }
}